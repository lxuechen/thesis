...
First, as deep learning models become larger and optimization algorithms become better, our models tend to \emph{memorize} non-trivial fragments of the data on which they were trained~\cite{}.
...
We use some of these privacy accounting techniques in this work for their tightness but direct the reader to the original papers for a thorough treatment.

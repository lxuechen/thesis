...
DP as a privacy definition enjoys several appealing properties. 
...
In the machine learning context, post-processing ensures that no additional privacy can be leaked when one queries a model trained with DP.

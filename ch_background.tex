...
Since the gradients are clipped to have norm less than $C$, the gradient sum has a sensitivity of $C$. 
One adds appropriate Gaussian noise in proportion to $C$.

...
another by including an additional record. 
In other words, $X$ and $X'$ always differ by 1 in terms of size.\footnote{
In other text, this is referred to as \emph{unbounded DP}~\cite{kifer2011no}. When ``neighboring'' is defined as two datasets of the same size differ by 1 element, it is referred to as \emph{bounded DP}.

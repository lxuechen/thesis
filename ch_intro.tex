...
The issue of privacy has gained considerable attention in the machine learning community in recent years as the increasing amount of user data generated on the internet becomes a potential source for training powerful predictive models. 
...
For instance, a South Korean company developed a chatbot based on (private) user data that regurgitated sensitive information such as people’s names, nicknames, and home addresses in its responses which led to a public relations incident~\cite{sk-chatbot}.

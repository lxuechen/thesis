...
% privacy has become an issue in ML. mention membership inference, data extraction.
% cite existing incidentes. comment on how this is a barrier to future applications.

% differential privacy
% limitations in past approaches of ml with dp... cite old works with big performance drops.
% comment on the perception issue.
	% comment on florian's work, which is an exception.
% the contribution of this thesis; summarized. then in bulletpoints list the specifics.
% potential of the contributions to be applied to other settings

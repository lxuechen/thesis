...
During my PhD, I have also contributed to the following research publications, which are excluded from this thesis.


\begin{mdframed}[leftline=true, topline=false, rightline=false, bottomline=false, linewidth=2pt]
Xuechen Li*, Daogao Liu*, Tatsunori B. Hashimoto, Huseyin A. Inan, Janardhan Kulkarni, Yin-Tat Lee, and Abhradeep Guha Thakurta. "When Does Differentially Private Learning Not Suffer in High Dimensions?" Advances in Neural Information Processing Systems (2022)~\cite{li2022does}.
\end{mdframed}

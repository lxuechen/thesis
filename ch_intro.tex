...
% DP-SGD is a common algo for training deep learning models with DP. give a brief intro (clipping, noising). why it's commonly used? what are the prior drawbacks?
% chpt3 presents ghost clipping. approaches to improve performance (prescriptive tuning). performance improves with larger and thus better pretrained models. low-rank tuning doesn't necessarily help.
% methods in chpt3 was good, but the memory-time tradeoff. 
